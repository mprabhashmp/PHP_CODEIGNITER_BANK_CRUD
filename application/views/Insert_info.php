...
<div class="testbox">
      ...
      <form action="<?php echo base_url();?>index.php/bank_control/saveData" method="POST">
        <div class="banner">
        ...
        <div class="item">
          ...
          <input id="bank_name" type="text" name="bank_name" pattern="[A-Za-z\s]+" title="Please enter English letters only."  required/>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <input id="account_no" type="text" name="acc_no" pattern="[0-9]+" title="Please enter numbers only." required/>
        </div>
    ...
    <div class="btn-block">
    <a href="<?php echo base_url();?>index.php/bank_control/index">  <button type="submit" >VIEW</button> </a>
        </div>
